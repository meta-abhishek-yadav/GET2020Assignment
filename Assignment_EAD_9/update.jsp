	...
	function currencyTypeChange() {
		...
		if (currency == "INR") {
			if (vehicle == "Bicycle") {
				...
				document.getElementById("yearlyPass").innerHTML = "Yearly Parking 2000 RS";
			} else if (vehicle == "FourWheeler") {
				document.getElementById("passCost").value = "0.21 $";				
				document.getElementById("dailyPass").innerHTML = "Daily Parking 15 RS";
				document.getElementById("monthlyPass").innerHTML = "Monthly Parking 300 RS";
				document.getElementById("yearlyPass").innerHTML = "Yearly Parking 3000 RS";
			}
		} else if (currency == "USD") {
			if (vehicle == "Bicycle") {
				document.getElementById("passCost").value = "0.07 $";				
				document.getElementById("dailyPass").innerHTML = "Daily Parking 1 $";
				document.getElementById("monthlyPass").innerHTML = "Monthly Parking 20$";
				document.getElementById("yearlyPass").innerHTML = "Yearly Parking 150$";
			} else if (vehicle == "MotorCycle") {
				document.getElementById("passCost").value = "0.14 $";				
				document.getElementById("dailyPass").innerHTML = "Daily Parking 2 $";
				document.getElementById("monthlyPass").innerHTML = "Monthly Parking 40$";
				document.getElementById("yearlyPass").innerHTML = "Yearly Parking 300$";
			} else if (vehicle == "FourWheeler") {
				document.getElementById("passCost").value = "0.21 $";				
				document.getElementById("dailyPass").innerHTML = "Daily Parking 3 $";
				document.getElementById("monthlyPass").innerHTML = "Monthly Parking 60$";
				document.getElementById("yearlyPass").innerHTML = "Yearly Parking 450$";

			}
		} else if (currency == "YEN") {
			if (vehicle == "Bicycle") {
				document.getElementById("passCost").value = "0.07 $";				
				document.getElementById("dailyPass").innerHTML = "Daily Parking 10 YEN";
				document.getElementById("monthlyPass").innerHTML = "Monthly Parking 200 YEN";
				document.getElementById("yearlyPass").innerHTML = "Yearly Parking 2000 YEN";
			} else if (vehicle == "MotorCycle") {
				document.getElementById("passCost").value = "0.14 $";
				document.getElementById("dailyPass").innerHTML = "Daily Parking 20 YEN";
				document.getElementById("monthlyPass").innerHTML = "Monthly Parking 400 YEN";
				document.getElementById("yearlyPass").innerHTML = "Yearly Parking 4000 YEN";
			} else if (vehicle == "FourWheeler") {
				document.getElementById("passCost").value = "0.21 $";
				document.getElementById("dailyPass").innerHTML = "Daily Parking 30 YEN";
				document.getElementById("monthlyPass").innerHTML = "Monthly Parking 600 YEN";
				document.getElementById("yearlyPass").innerHTML = "Yearly Parking 6000 YEN";
			}
		}
	}
	function passTypeChange() {
		...
		if (x == 0) {
			if (vehicle == "Bicycle") {
			 ...
			 if (vehicle == "Bicycle") {
					document.getElementById("passCost").value = "1.42 $";
				} else if (vehicle == "MotorCycle") {
					document.getElementById("passCost").value = "2.84 $";
				} else if (vehicle == "FourWheeler") {
					document.getElementById("passCost").value = "4.26 $";
				}
		} else if (x == 2) {
			if (vehicle == "Bicycle") {
				document.getElementById("passCost").value = "14.2 $";
			} else if (vehicle == "MotorCycle") {
				document.getElementById("passCost").value = "28.4 $";
			} else if (vehicle == "FourWheeler") {
				document.getElementById("passCost").value = "42.6 $";
			}
		}
