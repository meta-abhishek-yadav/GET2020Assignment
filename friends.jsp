...
<body>
 <% String email=(String)session.getAttribute("email");
    ...
    <panel><form id="friendsSelectForm" action="FriendData" method="post">
		<center>Select your friend by Email</center>
    <select id="friendsList" name="friendsList"></select></br>
    <input type="submit"></form>
    <% ArrayList<String> listOfFriends=(ArrayList<String>)session.getAttribute("friends");%>
