...
function fconfirmPassword(item, event) {
    var key = event.keyCode;
    if (key == 13) {
        if (item.value.length > 0) {
...
function fvehicleCompany(item, event) {
    var key = event.keyCode;
    if (key == 13) {
        if (item.value.length > 0) {
...
function fvehicleModel(item, event) {
    var key = event.keyCode;
    if (key == 13) {
        if (item.value.length > 0) {
...
function fvehicleNumber(item, event) {
    var key = event.keyCode;
    if (key == 13) {
        if (item.value.length > 0) {
...
function fvehicleIdentication(item, event) {
    var key = event.keyCode;
    if (key == 13) {
        if (item.value.length > 0) {
            if (item.value.length > 4) {
